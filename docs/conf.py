...
# -*- coding: utf-8 -*-
#
# guts documentation build configuration file, created by
...
from container_guts import version  # noqa
...
latex_documents = [
    ("index", "guts.tex", "guts Documentation", "Vanessa Sochat", "manual"),
]
...
texinfo_documents = [
    (
        ...
        ["Vanessa Sochat"],
        "guts",
        "guts is a tool for finding stuff on the PATH in a container",
        "Miscellaneous",
    ),
]
